...
import pytest
# import yaml
from pythonic_garage_band.Band import Musician, Guitarist ,Drummer , Bassist, Band
...
@pytest.fixture
def one_band():
    some_band = Band("Nirvana", [Guitarist("Kurt Cobain"), Bassist("Krist Novoselic"), Drummer("Dave Grohl"),],
    )
    return some_band
